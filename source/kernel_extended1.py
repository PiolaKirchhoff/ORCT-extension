...
class extended_kernel:
    ...
    def __init__(self,df,test,N=3,init={},type_reg="simple",reg_term = 0,ini = []):
        ...
        # It is a method that given a class label returns the indeces of instances belonging to that class
        def I_k(model,i):
            if i==0:
    ...
    def update(self, it = 1):
        ...
        for i in range(it):
            ...
            # LOOK AT sorct1_ex.py file for details
            # Initialization of class SORCT for building a model to store in the mother class
            w_l = SORCT_1(self.data_set,self.test,self.I_in_k,self.I_k,d = self.d)
