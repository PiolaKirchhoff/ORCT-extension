...
class Bagging_SORCT2:
    ...
    def __init__(self, df, N = 50, init={},type_reg="simple",reg_term = 0):
        ...
        self.init = init if init else generate_random_init(100)
        self.list_orct = []
    ...
    def solve(self):
        ...
        for i in range(self.N):
            ...
            # from now on the indeces are useless so i reset them
    ...
    def predict(self,X_test):
        ...
        """       
        pr = [self.list_orct[i].predicted_lab(X_test) for i in range(self.N)]
        pr_array = np.array(pr)
